...
public class SpecParamDTO {
    ...
    @ApiModelProperty(value = "是否是数字类型参数,1true2false")
    @NotNull(message = "是否是数字类型",groups = {MingruiOperation.Add.class,MingruiOperation.Update.class})
    private Boolean numeric;

    @ApiModelProperty(value = "数字类型参数的单位，非数字类型可以为空")
    private String unit;

    @ApiModelProperty(value = "是否是sku通用属性，1->true或0->false")
